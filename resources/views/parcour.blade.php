...
<section id="parcour" class="about section mt-5 pt-5">
    <div class="container section-title mt-5" data-aos="fade-up">
        <h2>À propos de moi</h2>
        <p>Mon objectif : optimiser la gestion des ressources et maximiser les retombées des projets grâce à une approche rigoureuse, structurée et orientée résultats</p>
    </div>
        ...
        <div class="row gy-4 align-items-center justify-content-between">
            ...
            <div class="col-xl-5" data-aos="fade-up" data-aos-delay="200">
                ...
                <p class="about-description">
                    ...
                    Merci à tous de me suivre, et n’hésitez pas à entrer en contact avec moi si vous souhaitez échanger ou collaborer sur des sujets liés au développement et à la gestion de projets, et au suivi évaluation. </p>
